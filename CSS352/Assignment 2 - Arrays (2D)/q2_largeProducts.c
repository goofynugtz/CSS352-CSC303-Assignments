...
Q2: Write a C program that takes two integer values as input, displays its product. 
[The integer value may be so large such that it exceeds range of max value of any integer.] 
...
//Question didn't ask for factorial but it was recommended in the class to try.
/* 
...
int main(){
  ...
  Enter the values in terminal or clear comment on line 149 for very large values in input.txt.
  */
